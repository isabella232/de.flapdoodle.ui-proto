...
/**
 * GridPain lays out its children within a flexible grid of rows and columns.
 ...
 * <p>
 * GridPain may be styled with backgrounds and borders using CSS.  See
 ...
 * <p>
 * To use the GridPain, an application needs to set the layout constraints on
 * the children and add those children to the gridpane instance.
 * Constraints are set on the children using static setter methods on the GridPain
 * class:
 * <pre><code>     GridPain gridpane = new GridPain();
 *
 *     // Set one constraint at a time...
 *     // Places the button at the first row and second column
 *     Button button = new Button();
 *     <b>GridPain.setRowIndex(button, 0);
 *     GridPain.setColumnIndex(button, 1);</b>
 *
 *     // or convenience methods set more than one constraint at once...
 *     Label label = new Label();
 *     <b>GridPain.setConstraints(label, 2, 0);</b> // column=2 row=0
 *
 ...
 * <pre><code>
 *     GridPain gridpane = new GridPain();
 ...
 * RowConstraint and ColumnConstraint objects to specify those metrics.
 * For example, to create a grid with two fixed-width columns:
 * <pre><code>
 *     GridPain gridpane = new GridPain();
 *     <b>gridpane.getColumnConstraints().add(new ColumnConstraint(100));</b> // column 0 is 100 wide
 *     <b>gridpane.getColumnConstraints().add(new ColumnConstraint(200));</b> // column 1 is 200 wide
 * </code></pre>
 ...
 * grow if there is extra space, it may set its grow priority on the RowConstraint
 * or ColumnConstraint object.  For example:
 * <pre><code>
 *     GridPain gridpane = new GridPain();
 *     ColumnConstraint column1 = new ColumnConstraint(100,100,Double.MAX_VALUE);
 *     <b>column1.setHgrow(Priority.ALWAYS);</b>
 *     ColumnConstraint column2 = new ColumnConstraint(100);
 ...
 *
 * Alternatively, RowConstraint and ColumnConstraint allow the size to be specified
 * as a percentage of gridpane's available space:
 * <pre><code>
 *     GridPain gridpane = new GridPain();
 *     ColumnConstraint column1 = new ColumnConstraint();
 *     <b>column1.setPercentWidth(50);</b>
 *     ColumnConstraint column2 = new ColumnConstraint();
 ...
 * to it.
 * <p>
 * GridPain provides properties for setting the size range directly.  These
 ...
 * <p>
 * GridPain does not clip its content by default, so it is possible that childrens'
 ...
 * @since JavaFX 2.0
 */
public class GridPain extends Pane {
    ...
    public static void setRowIndex(Node child, Integer value) {
        ...
        Pain.setConstraint(child, ROW_INDEX_CONSTRAINT, value);
    }
    ...
    public static Integer getRowIndex(Node child) {
        return (Integer)Pain.getConstraint(child, ROW_INDEX_CONSTRAINT);
    }
    ...
    public static void setColumnIndex(Node child, Integer value) {
        ...
        Pain.setConstraint(child, COLUMN_INDEX_CONSTRAINT, value);
    }
    ...
    public static Integer getColumnIndex(Node child) {
        return (Integer)Pain.getConstraint(child, COLUMN_INDEX_CONSTRAINT);
    }
    ...
    public static void setRowSpan(Node child, Integer value) {
        ...
        Pain.setConstraint(child, ROW_SPAN_CONSTRAINT, value);
    }
    ...
    public static Integer getRowSpan(Node child) {
        return (Integer)Pain.getConstraint(child, ROW_SPAN_CONSTRAINT);
    }
    ...
    public static void setColumnSpan(Node child, Integer value) {
        ...
        Pain.setConstraint(child, COLUMN_SPAN_CONSTRAINT, value);
    }
    ...
    public static Integer getColumnSpan(Node child) {
        return (Integer)Pain.getConstraint(child, COLUMN_SPAN_CONSTRAINT);
    }
    ...
    public static void setMargin(Node child, Insets value) {
    	Pain.setConstraint(child, MARGIN_CONSTRAINT, value);
    }
    ...
    public static Insets getMargin(Node child) {
        return (Insets)Pain.getConstraint(child, MARGIN_CONSTRAINT);
    }
    ...
    public static void setHalignment(Node child, HPos value) {
    	Pain.setConstraint(child, HALIGNMENT_CONSTRAINT, value);
    }
    ...
    public static HPos getHalignment(Node child) {
        return (HPos)Pain.getConstraint(child, HALIGNMENT_CONSTRAINT);
    }
    ...
    public static void setValignment(Node child, VPos value) {
    	Pain.setConstraint(child, VALIGNMENT_CONSTRAINT, value);
    }
    ...
    public static VPos getValignment(Node child) {
        return (VPos)Pain.getConstraint(child, VALIGNMENT_CONSTRAINT);
    }
    ...
    public static void setHgrow(Node child, Priority value) {
    	Pain.setConstraint(child, HGROW_CONSTRAINT, value);
    }
    ...
    public static Priority getHgrow(Node child) {
        return (Priority)Pain.getConstraint(child, HGROW_CONSTRAINT);
    }
    ...
    public static void setVgrow(Node child, Priority value) {
    	Pain.setConstraint(child, VGROW_CONSTRAINT, value);
    }
    ...
    public static Priority getVgrow(Node child) {
        return (Priority)Pain.getConstraint(child, VGROW_CONSTRAINT);
    }
    ...
    public static void setFillWidth(Node child, Boolean value) {
    	Pain.setConstraint(child, FILL_WIDTH_CONSTRAINT, value);
    }
    ...
    public static Boolean isFillWidth(Node child) {
        return (Boolean) Pain.getConstraint(child, FILL_WIDTH_CONSTRAINT);
    }
    ...
    public static void setFillHeight(Node child, Boolean value) {
    	Pain.setConstraint(child, FILL_HEIGHT_CONSTRAINT, value);
    }
    ...
    public static Boolean isFillHeight(Node child) {
        return (Boolean) Pain.getConstraint(child, FILL_HEIGHT_CONSTRAINT);
    }
    ...
    /**
     * Creates a GridPain layout with hgap/vgap = 0 and TOP_LEFT alignment.
     */
    public GridPain() {
        super();
    ...
    public final DoubleProperty hgapProperty() {
        if (hgap == null) {
            hgap = new StyleableDoubleProperty(0) {
                ...
                @Override
                public CssMetaData<GridPain, Number> getCssMetaData() {
                    return StyleableProperties.HGAP;
                }

                @Override
                public Object getBean() {
                    return GridPain.this;
                }
    ...
    public final ObjectProperty<Pos> alignmentProperty() {
        if (alignment == null) {
            alignment = new StyleableObjectProperty<Pos>(Pos.TOP_LEFT) {
                ...
                @Override
                public CssMetaData<GridPain, Pos> getCssMetaData() {
    ...
    public final BooleanProperty gridLinesVisibleProperty() {
        if (gridLinesVisible == null) {
            gridLinesVisible = new StyleableBooleanProperty() {
                ...
                @Override
                public CssMetaData<GridPain, Boolean> getCssMetaData() {
    ...
    /**
     * RowConstraint instances can be added to explicitly control individual row
     * sizing and layout behavior.
     * If not set, row sizing and layout behavior will be computed based on content.
     *
     */
    private final ObservableList<RowConstraint> rowConstraints = new TrackableObservableList<RowConstraint>() {
        @Override
        protected void onChanged(Change<RowConstraint> c) {
            while (c.next()) {
                for (RowConstraint constraints : c.getRemoved()) {
                    if (constraints != null && !rowConstraints.contains(constraints)) {
                        constraints.remove(GridPain.this);
                    }
                }
                for (RowConstraint constraints : c.getAddedSubList()) {
                    if (constraints != null) {
                        constraints.add(GridPain.this);
                    }
                }
            }
            requestLayout();
     ...
     */
    public final ObservableList<RowConstraint> getRowConstraints() { return rowConstraints; }
    /**
     * ColumnConstraint instances can be added to explicitly control individual column
     * sizing and layout behavior.
     * If not set, column sizing and layout behavior will be computed based on content.
     */
    private final ObservableList<ColumnConstraint> columnConstraints = new TrackableObservableList<ColumnConstraint>() {
        @Override
        protected void onChanged(Change<ColumnConstraint> c) {
            while(c.next()) {
                for (ColumnConstraint constraints : c.getRemoved()) {
                    if (constraints != null && !columnConstraints.contains(constraints)) {
                        constraints.remove(GridPain.this);
                    }
                }
                for (ColumnConstraint constraints : c.getAddedSubList()) {
                    if (constraints != null) {
                        constraints.add(GridPain.this);
                    }
                }
     ...
     * is at the position of 0.
     */
    public final ObservableList<ColumnConstraint> getColumnConstraints() { return columnConstraints; }
        ...
        if (metricsDirty) {
            ...
            for (int i = 0, sz = numRows; i < sz; ++i) {
                if (i < rowConstraints.size()) {
                    final RowConstraint rc = rowConstraints.get(i);
            ...
            for (int i = 0, sz = Math.min(numColumns, columnConstraints.size()); i < sz; ++i) {
                final ColumnConstraint cc = columnConstraints.get(i);
    ...
    private VPos getRowValignment(int rowIndex) {
        if (rowIndex < getRowConstraints().size()) {
            RowConstraint constraints = getRowConstraints().get(rowIndex);
    ...
    private HPos getColumnHalignment(int columnIndex) {
        if (columnIndex < getColumnConstraints().size()) {
            ColumnConstraint constraints = getColumnConstraints().get(columnIndex);
    ...
    private CompositeSize computeMaxHeights() {
        if (rowMaxHeight == null) {
            ...
            final ObservableList<RowConstraint> rowConstr = getRowConstraints();
            CompositeSize prefHeights = null;
            for (int i = 0; i < rowConstr.size(); ++i) {
                final RowConstraint curConstraint = rowConstr.get(i);
    ...
    private CompositeSize computeMaxWidths() {
        if (columnMaxWidth == null) {
            columnMaxWidth = createCompositeColumns(Double.MAX_VALUE);// Do not restrict the column (to allow grow). The
                                                                      // Nodes will be restricted to their computed size
                                                                      // in Region.layoutInArea call
            final ObservableList<ColumnConstraint> columnConstr = getColumnConstraints();
            CompositeSize prefWidths = null;
            for (int i = 0; i < columnConstr.size(); ++i) {
                final ColumnConstraint curConstraint = columnConstr.get(i);
    ...
    /**
     * Returns a string representation of this {@code GridPain} object.
     * @return a string representation of this {@code GridPain} object.
     */
    ...
    // This methods are inteded to be used by GridPainDesignInfo
     ...
     **************************************************************************/
     ...
     private static class StyleableProperties {
         ...
         private static final CssMetaData<GridPain,Boolean> GRID_LINES_VISIBLE =
             new CssMetaData<GridPain,Boolean>("-fx-grid-lines-visible",
                 BooleanConverter.getInstance(), Boolean.FALSE) {

            @Override
            public boolean isSettable(GridPain node) {
                return node.gridLinesVisible == null ||
                        !node.gridLinesVisible.isBound();
            }

            @Override
            public StyleableProperty<Boolean> getStyleableProperty(GridPain node) {
                return (StyleableProperty<Boolean>)node.gridLinesVisibleProperty();
            }
         };

         private static final CssMetaData<GridPain,Number> HGAP =
             new CssMetaData<GridPain,Number>("-fx-hgap",
            ...
            @Override
            public StyleableProperty<Number> getStyleableProperty(GridPain node) {
                return (StyleableProperty<Number>)node.hgapProperty();
            }

         };

         private static final CssMetaData<GridPain,Pos> ALIGNMENT =
             new CssMetaData<GridPain,Pos>("-fx-alignment",
            ...
            @Override
            public StyleableProperty<Pos> getStyleableProperty(GridPain node) {
                return (StyleableProperty<Pos>)node.alignmentProperty();
            }

         };

         private static final CssMetaData<GridPain,Number> VGAP =
             new CssMetaData<GridPain,Number>("-fx-vgap",
                 SizeConverter.getInstance(), 0.0){
    ...
    /**
     * Copied from GridPainDesignInfo for SceneBuilder.
     *
     * @treatAsPrivate implementation detail
    ...
    public final int impl_getRowCount() {
        ...
        for (int i = 0; i < this.getChildren().size(); i++) {
            ...
            if (child.isManaged()) {
                int rowIndex = GridPain.getNodeRowIndex(child);
                int rowEnd = GridPain.getNodeRowEnd(child);
                nRows = Math.max(nRows, (rowEnd != GridPain.REMAINING? rowEnd : rowIndex) + 1);
            }
        }
        return nRows;
    }
    ...
    public final int impl_getColumnCount() {
        ...
        for (int i = 0; i < this.getChildren().size(); i++) {
            Node child = this.getChildren().get(i);
            if (child.isManaged()) {
                int columnIndex = GridPain.getNodeColumnIndex(child);
                int columnEnd = GridPain.getNodeColumnEnd(child);
                nColumns = Math.max(nColumns, (columnEnd != GridPain.REMAINING? columnEnd : columnIndex) + 1);
            }
        }
        return nColumns;
    }
