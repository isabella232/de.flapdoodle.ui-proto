 ...
 * If a ColumnConstraint object is added for a column in a gridpane, the gridpane
 ...
 *     for (int i = 0; i < 5; i++) {
 *         ColumnConstraint column = new ColumnConstraint(100);
 ...
 * <pre><code>
 *     GridPane gridpane = new GridPane();
 *     ColumnConstraint col1 = new ColumnConstraint();
 *     col1.setPercentWidth(25);
 *     ColumnConstraint col2 = new ColumnConstraint();
 *     col2.setPercentWidth(50);
 *     ColumnConstraint col3 = new ColumnConstraint();
 *     col3.setPercentWidth(25);
 *     gridpane.getColumnConstraints().addAll(col1,col2,col3);
 * </code></pre>
 *
 * Note that adding an empty ColumnConstraint object has the effect of not setting
 ...
 * @since JavaFX 2.0
 */
public class ColumnConstraint extends ConstraintBase {
     ...
     */
    public ColumnConstraint(double width) {
        this();
     ...
     *
     */
    public ColumnConstraint(double minWidth, double prefWidth, double maxWidth, Priority hgrow, HPos halignment, boolean fillWidth) {
    ...
    /**
     * Returns a string representation of this {@code ColumnConstraint} object.
     * @return a string representation of this {@code ColumnConstraint} object.
     */
    @Override public String toString() {
        return "ColumnConstraint percentWidth="+getPercentWidth()+
